...
public:
	...
	void SendMsg(string target, int msgType, string msg, int type, bool anonymous);  //发送消息
	...
	void SetExclusiveTitle(string groupNumber, string qq, string title);  //设置专属头衔
	GroupMemberInfo GetGroupMemberInformation(string groupNumber, string qq);  //取群成员信息
	list<GroupMemberListInfo> GetGroutMemberListInformation(string groupNumber);  //取群成员列表信息
